...
class InstituteInvoiceProvider implements ProviderInterface
{
    ...
    public function provide(Operation $operation, array $uriVariables = [], array $context = []): array
    {
        ...
        if (!$currentUser instanceof User || !$this->canViewInvoices($currentUser, $institute)) {
            throw new AccessDeniedHttpException('Vous n\'avez pas les droits pour voir les factures de cet institut.');
        }

        return $this->entityManager->getRepository(Invoice::class)->findBy([
            'institute' => $institute,
        ]);
    }

    private function canViewInvoices(User $user, Institute $institute): bool
    {
