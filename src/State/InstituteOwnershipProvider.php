...
class InstituteOwnershipProvider implements ProviderInterface
{
    ...
    public function provide(Operation $operation, array $uriVariables = [], array $context = []): array
    {
        ...
        if (!$currentUser instanceof User || !$this->isMember($currentUser, $institute)) {
            throw new AccessDeniedHttpException('Vous n\'avez pas les droits pour voir les ownerships de cet institut.');
        }

        return $this->entityManager->getRepository(AssessmentOwnership::class)->findBy([
            'institute' => $institute,
        ]);
    }
